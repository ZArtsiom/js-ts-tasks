class User {
  ...
  // Setter functions for firstName and secondName
  set firstName(value) {
...
module.exports.createUsers = function (data) {
  ...
  return data.map(
    ({ firstName, secondName, age }) => module.exports.createUser(firstName, secondName, age) // ✅ Access via module.exports
  );
};
...
module.exports.createUsersSortFn = function (TestUtils) {
  return function (users) {
    return users.sort(TestUtils.compareUsers);
  };
};
